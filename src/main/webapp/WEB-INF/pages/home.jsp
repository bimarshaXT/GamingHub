...
<div class="simple-slider">
  ...
  <div class="text-overlay">
    ...
    <a id="slider-button" class="slider-cta">Explore</a>
  </div>
</div>


    
    <!-- Product Categories Section (Corsair Style) -->
        ...
        <div class="container">
            <div class="categories-grid">
                ...
                <a href="${pageContext.request.contextPath}/product?category=5" class="category-item medium">
                    ...
                    <img src="resources/images/chair-ad.avif" alt="Gaming PCs">
                </a>
                ...
                <a href="${pageContext.request.contextPath}/product?category=2" class="category-item medium">
                    ...
                    <img src="resources/images/processor-ad.jpg" alt="Memory">
                </a>
                ...
                <a href="${pageContext.request.contextPath}/product?category=4" class="category-item medium">
                    ...
                    <img src="resources/images/mouse-ad.jpeg" alt="Gaming Headsets">
                </a>
                ...
                <a href="${pageContext.request.contextPath}/product?category=6" class="category-item medium">
                    ...
                    <img src="resources/images/desk-ad.jpeg" alt="Power Supplies">
                </a>
                ...
                <a href="${pageContext.request.contextPath}/product?category=1" class="category-item large bottom">
                    ...
                    <img src="resources/images/monitor-ad.jpg" alt="Gaming Furniture">
                </a>
            </div>
        </div>
    </section>
  ...
  const slides = [
    {
      ...
      buttonText: "Shop Now",
      buttonLink: "${pageContext.request.contextPath}/product"
    },
    {
    ...
    },
    {
      ...
      buttonLink: "${pageContext.request.contextPath}/product?category=3"
    }
  ];
