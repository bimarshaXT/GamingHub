...
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/css/admin/productmanagement.css?v=1.4" />
<style>
table img {
	width: 60px;
	height: auto;
	...
	<div class="dashboard">
		<div class="sidebar">
			...
			<ul class="menu">
				...
				<li><a
					href="${pageContext.request.contextPath}/productmanagement"
		...
		<div class="sticky-header">
			...
			<div class="search-container">
				<form method="get"
					action="${pageContext.request.contextPath}/productmanagement"
					style="display: flex; gap: 10px;">
					<input type="text" name="searchTerm"
						placeholder="Search products..." value="${param.searchTerm}" />
					<button type="submit">
			...
			<div class="button-bar">
				...
				<form method="get"
					...
					<button type="submit" id="updateButton" class="disabled" disabled>Update
						Product</button>
				</form>
		...
		<table>
			...
			<tbody>
				...
				%>
				<tr>
					<td><input type="radio" name="selectedProduct"
						value="<%=product.getProduct_id()%>" /></td>
					<td><%=product.getProduct_id()%></td>
					<td><img
						src="<%=contextPath + "/resources/products/" + product.getImage_url()%>"
