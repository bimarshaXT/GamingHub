...
<c:set var="editMode" value="${param.editMode == 'true' || not empty error}" />
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${contextPath}/css/portfolio.css?v=1.2.3" />
    <%@ include file="/WEB-INF/pages/header.jsp" %>
</head>

<body>

<form action="${contextPath}/portfolio" method="post" enctype="multipart/form-data">
    <div class="portfolio-container">
        ...
        <div class="profile-box">
            ...
            <c:if test="${!editMode}">
                <a href="${contextPath}/portfolio?editMode=true">
                    <img src="${contextPath}/resources/images/editIcon.png" alt="Edit" class="edit-icon" />
                </a>
            </c:if>
            ...
            <div class="profile-image-wrapper">
                <c:choose>
                    <c:when test="${editMode}">
                        ...
                        <input type="hidden" name="oldImage" value="${customer.imageURL}" />
                    </c:when>
                    <c:otherwise>
        ...
        <c:if test="${editMode}">
            <div style="margin-top: 20px;">
                ...
                <a href="${contextPath}/portfolio" class="cancel-btn">Cancel Changes</a>
            </div>
        </c:if>
    </div>
</form>
