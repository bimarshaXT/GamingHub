...
<div class="container product-details">
    ...
    <div class="product-info">
        ...
        <div class="product-meta">
            ...
            <p><strong>Category Description:</strong> ${product.category.category_description}</p>

            <form id="orderForm" action="${contextPath}/product/details" method="post">
    <input type="hidden" name="productId" value="${product.product_id}" />
    <input type="hidden" name="productName" value="${product.product_name}" />
    <input type="hidden" name="productPrice" value="${product.price}" />
    <input type="hidden" name="productStock" value="${product.stock_quantity}" />
...
<form id="orderPageForm" action="${contextPath}/order" method="get">
    ...
    <a href="${contextPath}/product" class="back-link">← Back to Products</a>
</div>
